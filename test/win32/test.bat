...
pause
cd ..\
C:\Users\Nicolas\Desktop\ETDED.exe +set fs_basepath "C:\Users\Nicolas\Desktop\" +set fs_game etrun +map killua-pornstar +set g_APImodulePath "C:\Users\Nicolas\Desktop\etrun\APImodule.dll"
