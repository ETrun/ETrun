...
pause
cd ..\
C:\Users\Nicolas\Desktop\ETDED.exe +set fs_basepath "C:\Users\Nicolas\Desktop\" +set fs_game etrun +map bull-highway +set developer 1 +set g_useAPI 0 +set g_APImodulePath "C:\Users\Nicolas\Desktop\etrun\APImodule.dll"
