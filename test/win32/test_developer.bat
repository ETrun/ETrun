...
pause
cd ..\
C:\Users\Nicolas\Desktop\ETDEDd.exe +set fs_basepath "C:\Users\Nicolas\Desktop\" +set fs_game etrun +map test +set developer 1 +set dedicated 1 +set g_useAPI 0 +set g_APImoduleName "timeruns.mod"
