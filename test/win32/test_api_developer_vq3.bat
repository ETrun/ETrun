...
pause
cd ..\
C:\GameDev\ETtest\ETDED.exe +set fs_basepath "C:\GameDev\ETtest\" +set fs_game etrun +map killua-pornstar +set developer 1 +set dedicated 1 +set g_useAPI 1 +set g_APImoduleName "timeruns.mod" +set physics 19
