...
path_to_game_exec="/usr/local/games/enemy-territory/etded.x86"
...
"$path_to_game_exec" +set fs_basepath $basepath +set fs_game $mod_name +set dedicated 2 +map goldrush +set g_useAPI 1 +set g_APImodulePath "$path_to_api" +set developer 1
